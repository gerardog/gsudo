...
namespace gsudo.Helpers
{
    class ConsoleHelper
    {
        public static bool EnableVT()
        {
            ...
            {
                Logger.Log("Could not get console mode", LogLevel.Debug);
                return false;
            }
            ...
            {
                Logger.Log("Could not enable virtual terminal processing", LogLevel.Error);
                return false;
            }

            Logger.Log("Console VT mode enabled.", LogLevel.Debug);
            return true;
        }
    }
}
