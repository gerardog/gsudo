...
namespace gsudo
{
    class GlobalSettings
    {
        ...
        public static RegistrySetting<string> Prompt { get; set; } = new RegistrySetting<string>("Prompt", "$P# ");
        public static RegistrySetting<string> VTPrompt { get; set; } = new RegistrySetting<string>("VTPrompt", "$p$e[1;31;40m# $e[0;37;40m");
